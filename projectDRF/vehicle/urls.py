...
from .views import CarViewSet, MotoCreateAPIView, MotoListAPIView, MotoRetrieveAPIView, MotoDestroyAPIView, \
    MilageCreateAPIView, MotoMilageListAPIView, MilageListAPIView
...
urlpatterns = [
                  ...
                  path('moto/update/<int:pk>/', MotoRetrieveAPIView.as_view(), name='moto-update'),
