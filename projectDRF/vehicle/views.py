...
from .serializer import CarSerializer, MotoSerializer, MilageSerializer, MotoMilageSerializer, MotoCreateSerializer
from .tasks import chek_milage
...
class MilageCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        if new_milage.car:
            chek_milage.delay(new_milage.car_id, "Car")
        else:
            chek_milage.delay(new_milage.moto_id, "Moto")
